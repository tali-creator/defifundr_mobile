...
class _$VerifyingOtpImpl implements _VerifyingOtp {
  ...
  @override
  String toString() {
    return 'VerifyOtpState.verifyingOtp()';
  }
...
class _$OtpVerificationSuccessfulImpl implements _OtpVerificationSuccessful {
  ...
  @override
  String toString() {
    return 'VerifyOtpState.otpVerificationSuccessful(message: $message)';
  }
...
class _$OtpVerificationErrorImpl implements _OtpVerificationError {
  ...
  @override
  String toString() {
    return 'VerifyOtpState.otpVerificationError(message: $message)';
  }

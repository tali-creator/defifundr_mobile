...
class ImportWallet2 extends ConsumerStatefulWidget {
  const ImportWallet2({super.key});

  @override
  ConsumerState<ImportWallet2> createState() => _ImportWallet2State();
}

class _ImportWallet2State extends ConsumerState<ImportWallet2> {
  @override
